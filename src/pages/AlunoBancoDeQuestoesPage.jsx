...
import { ChevronDown, Database, GraduationCap, Menu, Monitor, Settings, Tag as TagIcon, X } from 'lucide-react'
        ...
        <div className="lg:hidden fixed inset-0 z-[70]">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[300px] bg-[#0F0627] flex flex-col">
            <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
              <img src="/logo-expanded.svg" alt="Connekt" className="w-[119px] h-[35px]" />
              <button type="button" className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center" onClick={() => setMobileNavOpen(false)} aria-label="Fechar menu">
                    ...
                    <div className="w-full max-w-[760px] rounded-[12px] border border-[#E3E4E5] bg-[#F8FAFC] p-6">
                      <div className="flex items-start gap-6">
                        <div className="min-w-0">
                          ...
                          <div className="mt-2 text-[12px] leading-[18px] text-[#737780] max-w-[420px]">
